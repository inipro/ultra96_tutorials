...
################################################################
# This is a generated script based on design: hw2_v1
#
...
if { $list_projs eq "" } {
   file delete -force hw2_v1
   create_project hw2_v1 hw2_v1 -part xczu3eg-sbva484-1-e
