...
################################################################
# This is a generated script based on design: vitis_ai_pfm
#
...
if { $list_projs eq "" } {
   ...
   create_project vitis_ai_pfm vitis_ai_pfm -part xczu3eg-sbva484-1-e
...
generate_target  all  [get_files  ./vitis_ai_pfm/vitis_ai_pfm.srcs/sources_1/bd/vitis_ai_pfm/vitis_ai_pfm.bd]
set_property generate_synth_checkpoint true [get_files -norecurse *.bd]
make_wrapper -files [get_files ./vitis_ai_pfm/vitis_ai_pfm.srcs/sources_1/bd/vitis_ai_pfm/vitis_ai_pfm.bd] -top
add_files -norecurse ./vitis_ai_pfm/vitis_ai_pfm.srcs/sources_1/bd/vitis_ai_pfm/hdl/vitis_ai_pfm_wrapper.v
